...
VACUUM_LAYER_PATH = PosixPath("data/copper/potassium/vacuum_layer")
SLAB_WIDTH_PATH = PosixPath("data/copper/potassium/width")
ENERGY_MAP_PATH = PosixPath("data/copper/potassium/energy_map")
