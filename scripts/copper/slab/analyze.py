...
from pseudopotential_calculator.calculations.slab import (
    plot_energy_against_n_vaccum_layer,
)
...
if __name__ == "__main__":
    _plot_energy_against_n_vaccum_layer()
