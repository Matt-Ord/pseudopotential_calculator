...
from pseudopotential_calculator.calculations.slab import plot_energy_against_slab_width
...
def _analyze_convergence_with_slab_width() -> None:
...
if __name__ == "__main__":
    _analyze_convergence_with_slab_width()
