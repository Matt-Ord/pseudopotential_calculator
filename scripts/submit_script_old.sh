...
#! The Cascade Lake (icelake) nodes have 56 CPUs (cores) each and
...
module load rhel8/default-peta4 castep          # REQUIRED - loads the basic environment
